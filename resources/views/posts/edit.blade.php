            ...
            <div class="card-body">
                ...
                <form action="{{route('post.update',$post)}}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" id="" value="{{ old('title', $post->title ) }}" aria-describedby="" placeholder="请输入标题">
                    ...
                    <div class="form-group">
                        ...
                        <input id="tags-input" name="tags" type="text" value="{{ old('title', $post->tags ) }}">
